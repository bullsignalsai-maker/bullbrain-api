...
SP500_LIST = {
    ...
    "XYL","YUM","ZBH","ZBRA","ZTS","SMCI","DELL","ARM","SNAP","NOK","SOFI","RIVN","LCID","HOOD","COIN","MSTR",
    "CRWD","APP","VRT","FIX","SNDK","WDC","STX","CIEN","TTD","SHOP","UBER","PLTR",
    "DKNG","RKLB","SOUN","ASTS","HIMS","UPST","PATH","TOST","AFRM","CVNA","RBLX","COIN","HOOD","MSTR","RDDT","RKLB","SOUN","ASTS","HIMS","UPST","PATH","TOST","AFRM",
    "CVNA","RBLX","DKNG","APP","VRT","FIX","LITE","COHR","SATS","TERN","BYND","EZGO",
    "NOK","SNAP","INTC","MU","AMD","DELL","ARM","TTD","SHOP","UBER","PFE","BAC","AMD",
    "SOFI","LCID","RIVN","PLUG","FCEL","MARA","RIOT","CLSK","BITF","IREN","WULF","BTBT",
    "OKLO","SMR","NNE","LUNR","SERV","BBAI","TEM","GTLB","ZS","NET","CRWD","PANW","SNOW",
    "DDOG","MDB","ESTC","AI","IONQ","RGTI","QBTS","PSNL","BFLY","TLRY","CGC","ACB"
}
